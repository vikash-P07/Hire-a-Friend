...
<head>
    ...
    <title>@yield('title', 'Companion Partner Portal | Hire-a-Friend')</title>
    <meta name="description" content="@yield('meta_description', 'Your companion dashboard panel')">
    ...
    <style>
        /* ═══════════════════════════════════════════
           DESIGN SYSTEM TOKENS (REUSED FROM CUSTOMER)
        ═══════════════════════════════════════════ */
        :root {
            --brand-purple: #7c3aed;
        ...
        * { box-sizing: border-box; }
        ...
        .badge-rescheduled { background: rgba(6,182,212,0.12); color: #0891b2; }
...
<div class="c-layout" id="dashLayout">
    ...
    <aside class="c-sidebar" id="cSidebar">
        ...
        <a href="{{ route('partner.dashboard') }}" class="sidebar-brand">
            <div class="sidebar-brand-icon">
                <i class="bi bi-people-fill"></i>
            </div>
            <div>
                <div class="sidebar-brand-text">Hire-a-Friend</div>
                <div class="sidebar-brand-sub">Companion Portal</div>
            </div>
        </a>
        ...
        <div class="sidebar-scroll">
            ...
            <ul class="sidebar-nav">
                <li>
                    <a href="{{ route('partner.dashboard') }}"
                       class="sidebar-link {{ Route::is('partner.dashboard') ? 'active' : '' }}">
                ...
                <li>
                    <a href="{{ route('partner.profile') }}"
                       class="sidebar-link {{ Route::is('partner.profile') ? 'active' : '' }}">
                ...
                <li>
                    <a href="{{ route('partner.bookings') }}"
                       class="sidebar-link {{ Route::is('partner.bookings') ? 'active' : '' }}">
                        <i class="bi bi-calendar-check"></i>
                        <span>Booking Requests</span>
                        @php 
                            $pendingBookingsCount = \App\Models\Booking::where('partner_id', Auth::id())->where('status', 'pending')->count();
                        @endphp
                        @if($pendingBookingsCount > 0)
                            <span class="sidebar-badge badge bg-warning text-theme-primary">{{ $pendingBookingsCount }}</span>
                        @endif
                    </a>
                </li>
                <li>
                    <a href="{{ route('partner.messages') }}"
                       class="sidebar-link {{ Route::is('partner.messages') ? 'active' : '' }}">
            ...
            <div class="sidebar-section-label">Finance & Performance</div>
            <ul class="sidebar-nav">
                <li>
                    <a href="{{ route('partner.earnings') }}"
                       class="sidebar-link {{ Route::is('partner.earnings') ? 'active' : '' }}">
                        <i class="bi bi-wallet2"></i>
                        <span>Earnings</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('partner.availability') }}"
                       class="sidebar-link {{ Route::is('partner.availability') ? 'active' : '' }}">
                ...
                <li>
                    <a href="{{ route('partner.analytics') }}"
                       class="sidebar-link {{ Route::is('partner.analytics') ? 'active' : '' }}">
            ...
            <div class="sidebar-section-label">Growth & Promotion</div>
            <ul class="sidebar-nav">
                <li>
                    <a href="{{ route('partner.subscription') }}"
                       class="sidebar-link {{ Route::is('partner.subscription') ? 'active' : '' }}">
    ...
    <div class="c-main">
        ...
        <header class="c-topbar">
            <div class="d-flex align-items-center gap-3">
                ...
                <span class="fw-bold d-none d-sm-inline" style="color:var(--text-secondary);">Companion Partner Panel</span>
            </div>
            ...
            <div class="topbar-actions">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end user-dropdown-menu" aria-labelledby="partnerUserMenu">
                        <li class="menu-header">
                            <div class="fw-bold text-truncate" style="font-size:0.85rem;color:var(--text-primary);max-width:190px;">{{ Auth::user()->name }}</div>
                            <div class="mt-1"><span class="badge rounded-pill" style="background:rgba(124,58,237,0.12);color:#7c3aed;font-size:0.7rem;letter-spacing:0.04em;">COMPANION PARTNER</span></div>
                        </li>

                        <li><a class="c-dropdown-item" href="{{ route('partner.profile') }}"><i class="bi bi-person-lines-fill"></i> Profile</a></li>
                        <li><a class="c-dropdown-item" href="{{ route('partner.profile') }}"><i class="bi bi-gear"></i> Settings</a></li>
        ...
        <div class="c-body">
            ...
            @if(session('warning'))
                <div class="alert-brand d-flex align-items-center gap-3 mb-4" role="alert">
                    <i class="bi bi-exclamation-circle-fill text-primary fs-5"></i>
...
<div class="position-fixed bottom-0 end-0 p-3" style="z-index:9999;">
    <div id="comingSoonToast" class="toast align-items-center text-white border-0" role="alert" style="background: var(--brand-gradient); border-radius: var(--radius-md);">
        <div class="d-flex">
            <div class="toast-body d-flex align-items-center gap-2">
                <i class="bi bi-rocket-takeoff-fill"></i>
                <span id="comingSoonText">Feature coming soon!</span>
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const savedScroll = sessionStorage.getItem('partnerSidebarScroll');
    ...
    if (sidebarScroll) {
        sidebarScroll.addEventListener('scroll', function() {
            sessionStorage.setItem('partnerSidebarScroll', sidebarScroll.scrollTop);
        });
    }
});
